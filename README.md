...
- Vendas: hoje a importação só empilha — se um dia já tem vendas registradas
  para a loja, um novo upload daquele dia é ignorado (não substitui). Pensar
  numa opção de "substituir" vendas de um dia/loja específicos, para quando
  precisar corrigir um arquivo já importado
